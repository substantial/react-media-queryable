...
class _class extends React.Component {
  constructor(...args) {
    ...
    }, this.mediaListener = null, this._currentMediaQuery = () => {
      return this.state.mediaQuery || this.props.defaultMediaQuery || null;
    }, this._onMediaQueryChange = name => {
      this.setState({
        mediaQuery: name
      });
    }, _temp;
...
_class.propTypes = {
  ...
  defaultMediaQuery: index.string.isRequired,
  mediaQueries: index.object.isRequired,
  style: index.object
};
